        ...
        <div className="h-96">
          ...
          <div className="p-3 flex ">
            <div className="bg-black">
              ...
              <p>En Otra Ronda, la emoción se mezcla con la creatividad en cada vaso que servimos. Cada detalle está cuidadosamente pensado para brindar una experiencia sensorial única. Nos enorgullecemos de nuestra atención al cliente y de la calidad de nuestros tragos.</p>
